...
When I completed my dissertation, I did not touch it for 2 years because I was on clinical internship and did not have the time to do so during my first year of postdoc. However, I did want to make some edits to analyses to prepare this project for publication. Namely, I wanted to separate out psychological IPV perpetration into minor and severe subscales to see if effects hold and to explore how to deal with missing data using the `mi` function in `brms`. These updated analyses are in the branch "update-for-pub". Of note, the last version of this project that can be used to reproduce analyses from my dissertation document is: ec17594196715e05260b8c95719682f9fece3249.
